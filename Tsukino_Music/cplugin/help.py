...
from Tsukino_Music.utils import first_page, second_page
from Tsukino_Music.utils.database import get_lang
from Tsukino_Music.utils.decorators.language import LanguageStart, languageCB
from Tsukino_Music.utils.inline.help import help_back_markup, private_help_panel
    ...
    if cb == "hb9":
        if CallbackQuery.from_user.id not in SUDOERS:
            return await CallbackQuery.answer(
                "😎HAR JAGAH TSUKINO CHALEGA AB😆😆", show_alert=True
            )
        else:
