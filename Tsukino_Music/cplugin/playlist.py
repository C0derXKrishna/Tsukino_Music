...
from Tsukino_Music.utils import close_markup
from config import BANNED_USERS, SERVER_PLAYLIST_LIMIT
from Tsukino_Music import Carbon, app
from Tsukino_Music.utils.decorators.language import language, languageCB
from Tsukino_Music.utils.inline.playlist import (
    botplaylist_markup,
    get_playlist_markup,
    warning_markup,
)
...
from Tsukino_Music.core.mongo import mongodb
...
async def add_playlist_clone(client: Client, message: Message, _):
    ...
    if "https://youtu.be" in query:
        ...
        from Tsukino_Music import YouTube
