...
from Tsukino_Music.utils.database import get_served_chats_clone
from Tsukino_Music import userbot
from Tsukino_Music.core.mongo import mongodb, pymongodb
    ...
    [
        [
            InlineKeyboardButton(
                "๏ BRAND ๏",
                url=f"https://t.me/Tsukino_Music",
            )
        ]
    ]
)
...
🔐ᴜꜱᴇ » [/start](https://t.me/Tsukino_Music_Bot?start=help) ᴛᴏ ᴄʜᴇᴄᴋ ʙᴏᴛ

➲ ʙᴏᴛ :** @Tsukino_Music_Bot"""
...
BUTTON = InlineKeyboardMarkup(
    [
        [
            InlineKeyboardButton(
                "๏ ᴋɪᴅɴᴀᴘ ᴍᴇ ๏",
                url=f"https://t.me/Tsukino_Music_Bot?startgroup=s&admin=delete_messages+manage_video_chats+pin_messages+invite_users",
            )
        ]
    ]
)
