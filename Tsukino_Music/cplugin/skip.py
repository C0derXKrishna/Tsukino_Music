...
from Tsukino_Music.utils.database import get_loop
from Tsukino_Music.utils.decorators import AdminRightsCheck
from Tsukino_Music.utils.inline import close_markup, stream_markup, stream_markup2
    ...
    if "live_" in queued:
        ...
        run = await message.reply_photo(
            ...
            caption=_["stream_1"].format(
                f"https://t.me/Tsukino_Music_Bot?start=info_{videoid}",
                title[:23],
                check[0]["dur"],
                user,
            ),
